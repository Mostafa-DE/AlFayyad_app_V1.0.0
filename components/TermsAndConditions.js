...
function TermsAndConditions() {
  return (
    <>
      <h1 className={styles.h1Text}>Terms of service</h1>
      <div className={`text-start container ${styles.containerAllTerms} `}>
        <h5 className="text-uppercase">overview</h5>
        <p className="text-md-start">
          This website is operated by Alfayyad For European Products.Throughout
          the site, the terms “we”, “us” and “our” refer to Alfayyad For
          European Products. Alfayyad For European Products offers this website,
        ...
        <p className="text-md-start">
          By visiting our site and/or purchasing a product or service from us,
        ...
        <h5 className="text-uppercase">SECTION 1 - ONLINE STORE TERMS</h5>
        <p className="text-md-start">
          By agreeing to these Terms of Service, you represent that you are at
          least the age of majority in your state, province or country of
          residence, or that you are the age of majority in your state, province
          or country of residence and you have given us your consent to allow
        ...
        <h5 className="text-uppercase">SECTION 2 - GENERAL CONDITIONS</h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 5 - PRODUCTS OR SERVICES</h5>
        <p className="text-md-start">
        ...
        <p className="text-md-start">
          ...
          email address and credit card number(s) and expiration date(s), so
          that we can complete your transactions and contact you as needed.
        </p>
        <p className="text-md-start">
          At the moment we do not accept online payment, the only payment method
          we provide, cash on delivery only
        </p>
        <p className="text-md-start">
          For more details, please contact us via the means of communication we
          provide
        </p>
        <h5 className="text-uppercase">SECTION 7 - OPTIONAL TOOLS</h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 8 - THIRD-PARTY LINKS</h5>
        <p className="text-md-start">
        ...
        <p className="text-md-start">
          ...
          or evaluating their content or accuracy and we do not warrant and will
        ...
        <p className="text-md-start">
          ...
          no obligation to: (1) maintain any comments in confidence; (2) pay
          compensation for any comments; or (3) respond to any comments.
        </p>
        <p className="text-md-start">
          We may, but have no obligation to, monitor, edit or remove content
          that we determine in our sole discretion is unlawful, offensive,
          threatening, libelous, defamatory, pornographic, obscene or otherwise
          objectionable or violates any party’s intellectual property or these
          Terms of Service.
        </p>
        <h5 className="text-uppercase">SECTION 10 - PERSONAL INFORMATION</h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 12 - PROHIBITED USES</h5>
        <p className="text-md-start">
          In addition to other prohibitions as set forth in the Terms of
          Service, you are prohibited from using the site or its content:
          <br /> (a) for any unlawful purpose.
          <br /> (b) to solicit others to perform or participate in any unlawful
          acts.
          <br /> (c) to violate any international, national, federal, provincial
          or state regulations, rules, laws, or local ordinances.
          <br /> (d) to infringe upon or violate our intellectual property
          rights or the intellectual property rights of others.
          <br /> (e) to harass, abuse, insult, harm, defame, slander, disparage,
          intimidate, or discriminate based on gender, sexual orientation,
          religion, ethnicity, race, age, national origin, or disability.
          <br /> (f) to submit false or misleading information.
          <br /> (g) to upload or transmit viruses or any other type of
          ...
          <br /> (l) minors under the age of 18 shall are prohibited to register
          as a user of this website and are not allowed to transact or use the
          website.
        </p>
        <p className="text-md-start">
        ...
        <p className="text-md-start">
          In no case shall alfayyad for european products, our directors,
          ...
          if advised of their possibility. As some states or jurisdictions do
        ...
        <h5 className="text-uppercase">SECTION 14 - INDEMNIFICATION</h5>
        <p className="text-md-start">
          You agree to indemnify, defend and hold harmless (alfayyad for
          european products) and our parent, subsidiaries, affiliates, partners,
        ...
        <h5 className="text-uppercase">SECTION 15 - SEVERABILITY</h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 16 - TERMINATION</h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 17 - ENTIRE AGREEMENT </h5>
        <p className="text-md-start">
        ...
        <h5 className="text-uppercase">SECTION 18 - GOVERNING LAW</h5>
        <p className="text-md-start">
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of Jordan, our country of domicile.
        </p>
        <h5 className="text-uppercase">
        ...
        <h5 className="text-uppercase">SECTION 20 - CONTACT INFORMATION</h5>
        <p className="text-md-start">
